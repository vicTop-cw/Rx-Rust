...
│   ├── Cargo.toml           # 包配置
│   └── README.md            # Rust 侧文档
├── rx-rust-py/              # Python 绑定（PyO3）
│   ├── src/                 # Rust PyO3 绑定代码
│   │   ├── clipboard/       # 剪贴板模块
│   │   ├── keyboard_mouse/  # 键盘鼠标模块
│   │   ├── file_watcher.rs  # 文件监控
│   │   └── folder_watcher.rs # 文件夹监控
│   ├── python/rx_rust/      # Python 包
│   │   ├── __init__.py      # 包入口
│   │   ├── keyboard_mouse.py # 键盘鼠标模块
│   │   └── keyboard_mouse.pyi # 类型存根
│   ├── Cargo.toml
...
├── examples/                # 示例代码
│   ├── basic_usage.py       # 基础用法
│   ├── keyboard_example.py  # 键盘示例
│   └── mouse_example.py     # 鼠标示例
├── docs/                    # 文档
│   └ guides/                # 使用指南
│   │   ├── main_guide.md    # 主指南
│   │   └── keyboard_mouse_guide.md # 键鼠指南
├── analysis/                # 分析文档
│   ├── polars_operators_comparison.md
│   └── spark_rdd_operators_comparison.md
├── dev-tools/               # 开发工具
│   ├── benchmarks/          # 性能基准测试
│   │   ├── benchmark.py
│   │   └── benchmark_v2.py
...
- **[docs/guides/main_guide.md](docs/guides/main_guide.md)** — 完整的使用指南！包含：
  - 所有操作符的详细说明和代码示例
  ...
  - Python API 参考
  - 调试与排错指南
- **[docs/guides/keyboard_mouse_guide.md](docs/guides/keyboard_mouse_guide.md)** — 键盘鼠标模块完整指南
- **[examples/](examples/)** — 示例代码目录
- **[rx-rust/README.md](rx-rust/README.md)** — Rust 侧库说明
- **[rx-rust-py/README.md](rx-rust-py/README.md)** — Python 侧包说明
- **[analysis/](analysis/)** — 与 Polars/Spark RDD 的操作符对比分析
